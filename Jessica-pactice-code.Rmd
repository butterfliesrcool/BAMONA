...
Plot all 10% graphs together:
```{r}
all.kern.10 <- b + geom_sf(data = bat.kern10, color = "salmon1", fill = "salmon1", alpha = 0.3) + 
              geom_sf(data = lim.kern10, color = "royalblue1", fill = "royalblue1", alpha = 0.5) +
              geom_sf(data = gla.kern10, color = "olivedrab", fill = "olivedrab", alpha = 0.5) +
              geom_sf(data = pol.kern10, color = "plum4", fill = "plum4", alpha = 0.5) +
              geom_sf(data = tro.kern10, color = "tan1", fill = "tan1", alpha = 0.5) + 
              geom_sf(data = dia.kern10, color = "seagreen1", fill = "seagreen1", alpha = 0.5) +
