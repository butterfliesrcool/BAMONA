...
1. Make "all.kern" maps for  90%, 80%, 70%, 60%, 50%, 40%, 30%, and 20% 
2. Make heat maps for species density 
3. Figure out how to get state lines on the US map 
4. Figure out how to analyze these population density correlations statistically 
5. Get data from iNaturalist and rerun this code with larger, more accurate sample sizes 
