---
title: "iNaturalist_practice_code"
author: "Maria Osipovich"
date: "10/14/2022"
...
b <- subset(clean.battus, select = -c(observed_on,quality_grade,url,description,place_guess,positional_accuracy,private_place_guess,private_latitude,private_longitude,public_positional_accuracy,geoprivacy,taxon_geoprivacy,coordinates_obscured,positioning_method,positioning_device,common_name ) )
length(battus$id)
battus
```
...
length(clean.limenitis$id)

l <- subset(clean.limenitis, select = -c(observed_on,quality_grade,url,description,place_guess,positional_accuracy,private_place_guess,private_latitude,private_longitude,public_positional_accuracy,geoprivacy,taxon_geoprivacy,coordinates_obscured,positioning_method,positioning_device,common_name ) )
length(limenitis$id)
limenitis
```
...
g <- subset(clean.glaucus, select = -c(observed_on,quality_grade,url,description,place_guess,positional_accuracy,private_place_guess,private_latitude,private_longitude,public_positional_accuracy,geoprivacy,taxon_geoprivacy,coordinates_obscured,positioning_method,positioning_device,common_name ) )
...
p <- subset(clean.polyxenes, select = -c(observed_on,quality_grade,url,description,place_guess,positional_accuracy,private_place_guess,private_latitude,private_longitude,public_positional_accuracy,geoprivacy,taxon_geoprivacy,coordinates_obscured,positioning_method,positioning_device,common_name ) )
...
t <- subset(clean.troilus, select = -c(observed_on,quality_grade,url,description,place_guess,positional_accuracy,private_place_guess,private_latitude,private_longitude,public_positional_accuracy,geoprivacy,taxon_geoprivacy,coordinates_obscured,positioning_method,positioning_device,common_name ) )
...
library("rstudioapi")
library("ggmap")
register_google(key = "AIzaSyC9inTkefV2ApM_f363LUmxIRRbEAdZkVw")
```
